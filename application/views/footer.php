<footer id="colorlib-footer" role="contentinfo">
    <div class="container">
        <div class="row row-pb-md">
            ...
            <div class="col-md-3">
                <h2>Beğendiğim Gönderiler</h2>
                <div class="f-blog">
                    <a href="<?php echo base_url();?>blog" class="blog-img" style="background-image: url(<?php echo base_url();?>assets/images/blog-1.jpg);">
                    </a>
                    <div class="desc">
                        <h3><a href="<?php echo base_url();?>blog">Be a designer</a></h3>
                        <p class="admin"><span>25 March 2018</span></p>
                    </div>
                </div>
                <div class="f-blog">
                    <a href="<?php echo base_url();?>blog" class="blog-img" style="background-image: url(<?php echo base_url();?>assets/images/blog-2.jpg);">
                    </a>
                    <div class="desc">
                        <h3><a href="<?php echo base_url();?>blog">How to build website</a></h3>
                        <p class="admin"><span>24 March 2018</span></p>
                    </div>
                </div>
                <div class="f-blog">
                    <a href="<?php echo base_url();?>blog" class="blog-img" style="background-image: url(<?php echo base_url();?>assets/images/blog-3.jpg);">
                    </a>
                    <div class="desc">
                        <h3><a href="<?php echo base_url();?>blog">Create website</a></h3>
