            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <div class="header-top-menu">
                    <ul class="nav navbar-nav notika-top-nav">
                        ...
                        <li><a href="<?php base_url();?>giris/logout"><?php echo $_SESSION['username'];?> Logout</a></li>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                    <li class="active"><a data-toggle="tab" href=<?php echo base_url();?>Panel><i class="notika-icon notika-house"></i> Home</a>
                    </li>
                    <li><a data-toggle="tab" href="#mailbox"><i class="notika-icon notika-mail"></i> Messages</a>
                    </li>
                ...
                <div class="tab-content custom-menu-content">
                    ...
                    <div id="mailbox" class="tab-pane notika-tab-menu-bg animated flipInX">
                        <ul class="notika-main-menu-dropdown">
                            <li><a href=<?php echo base_url();?>message>Inbox</a>
                            </li>
                            <li><a href=<?php echo base_url();?>message/message_sendbox>Sends</a>
                            </li>
                            <li><a href=<?php echo base_url();?>message/message_new>New Message</a>
                            </li>
                        </ul>
                    </div>
                    <div id="Interface" class="tab-pane notika-tab-menu-bg animated flipInX">
                        <ul class="notika-main-menu-dropdown">
                            ...
                            <li><a href=<?php echo base_url();?>posts/gonderi_ekle>New Posts</a>
                            </li>
                            <li><a href=<?php echo base_url();?>posts/gonderileri_duzenle>Edit Posts</a>
                            </li>
                            <li><a href=<?php echo base_url()?>posts/deleteposts>Delete Posts</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div id="Page" class="tab-pane notika-tab-menu-bg animated flipInX">
                        <ul class="notika-main-menu-dropdown">
                            ...
                            <li><a href=<?php echo base_url();?>member/duzenle>Edit</a>
                            </li>
                            <li><a href="typography.html">Change Password</a>
                            </li>
                            <li><a href="color.html">Change Profile Picture</a>
                            </li>
                            <li><a href="login-register.html">Freeze Account</a>
                            </li>
                            <li><a href="404.html">Delete Account</a>
                            </li>
                        </ul>
                    </div>
                </div>
