...
<center>
    ...
    <table id="personel">
        ...
        <tr>
            ...
            <td><a href="<?php echo base_url()."posts/neweditpost/".$row->id;?>" class="btn btn-primary">Edit</a></td>
            <td><a href="<?php echo base_url()."posts/deleteposts/".$row->id;?>" class="btn btn-danger">Delete</a></td>
        </tr>
        <?php }?>
    </table>
