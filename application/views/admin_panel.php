...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?php echo base_url();?>/assets_admin_panel/img/favicon.ico">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="<?php echo base_url();?>/assets_admin_panel/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo base_url();?>/assets_admin_panel/css/tree-viewer.css">
    <link rel="stylesheet" href="<?php echo base_url();?>/assets_admin_panel/css/style.css">
</head>
...
<div class="wrapper">
    <div class="left-side">
        <div class="logo">
            <img src="<?php echo base_url();?>/assets_admin_panel/img/logo.png" alt="" />
        </div>
...
<xmp>
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="logo">
                    <a href="<?php echo base_url();?>/assets_admin_panel/dashboard.html">
                        <img src="<?php echo base_url();?>/assets_admin_panel/img/logo.png" alt="">
                    </a>
                </div>
            </div><!-- column end -->
	...
	<!-- summernote CSS
		============================================ -->
        <link rel="stylesheet" href="<?php echo base_url();?>/assets_admin_panel/css/summernote.css">
	</xmp>
</pre>
	...
	<!-- summernote JS
		============================================ -->
        <script src="<?php echo base_url();?>/assets_admin_panel/js/summernote.min.js"></script>
        <script src="<?php echo base_url();?>/assets_admin_panel/js/summernote-active.js"></script>
	</xmp>
</pre>
...
<script src="<?php echo base_url();?>/assets_admin_panel/js/jquery-3.1.0.min.js"></script>
<script src="<?php echo base_url();?>/assets_admin_panel/js/bootstrap.min.js"></script>
<script src="<?php echo base_url();?>/assets_admin_panel/js/jstree.min.js"></script>
<script src="<?php echo base_url();?>/assets_admin_panel/js/jstree.active.js"></script>
<script src="<?php echo base_url();?>/assets_admin_panel/js/main.js"></script>
</body>
