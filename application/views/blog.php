        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 breadcrumbs text-center">
                    <h2>Blog Oku</h2>
                    <p><span><a href="<?php echo base_url();?>">Anasayfa</a></span> / <span>Blog</span></p>
                </div>
            </div>
        </div>
    </aside>
        ...
        <div class="container">
            ...
            <div class="row row-pb-md">
                ...
                <div class="col-md-4">
                    <div class="blog-entry">
                        <div class="blog-img">
                            <a href="blog.html"><img src="<?php echo base_url();?>/assets/images/blog-5.jpg" class="img-responsive" alt="html5 bootstrap template"></a>
                        </div>
                        <div class="desc">
                            <p class="meta">
                                <span class="cat"><a href="#">Events</a></span>
